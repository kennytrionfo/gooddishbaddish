...
class DishesControllerTest < ActionController::TestCase
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post :create, dish: { description: @dish.description, dish_name: @dish.dish_name, rating: @dish.rating }
    end
  ...
  test "should update dish" do
    patch :update, id: @dish, dish: { description: @dish.description, dish_name: @dish.dish_name, rating: @dish.rating }
    assert_redirected_to dish_path(assigns(:dish))
  end
